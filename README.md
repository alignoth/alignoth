...
|-----------------------|-------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| bam-path              | -b    | The bam file(s) to be visualized. Accepts local paths or `http(s)`/`ftp` URLs like samtools. Remote files need a matching index (`.bai`/`.csi`). When multiple bam files are given they will get concatenated vertically. |         |
