!(function (e, t) {
  ...
  class wc extends $c {
    ...
    hash() {
      return (
        void 0 === this._hash && (this._hash = `Output ${I()}`),
        this._hash
      );
    }
    getSource() {
  ...
  function Au(e, t) {
    return Dn.reduce(
      (n, i) => (
        !_u.has(i) && J(e, i) && "ignore" !== t[i] && (n[i] = Pn(e[i])),
        n
      ),
      {},
    );
  ...
  const Eu = "voronoi",
    Mu = {
      ...
      marks: (e, t, n) => {
        ...
        if (Zr(o))
          return (
            Si(`The "nearest" transform is not supported for ${o} marks.`),
            n
          );
        const a = {
          name: e.getName(Eu),
    ...
    Uu = {
      ...
      signals: (e, t, n) => {
        ...
        if ("interval" === t.type)
          ...
          (i(e, "null"),
            qu.defined(t) &&
              ((e = n.findIndex((e) => e.name === t.name + Lu)),
              i(e, "false")));
        }
        return n;
      },
  ...
  class Kd extends $c {
    ...
    static makeFromEncoding(e, n) {
      ...
      if (t.isArray(f) || Zo(f)) d = qn(f);
        ...
        d = u.reduce(
          (t, n) => (
            t.field.includes(n) || (t.field.push(n), t.order.push(e)),
            t
          ),
          { field: [], order: [] },
        );
  ...
  function Op(e, t) {
    ...
    return (
      S(y) || i.set("encode", y, !!n.encoding || void 0 !== n.labelAngle),
      i
    );
  }
  function zp(e, t) {
  ...
  ((e.accessPathDepth = q),
    ...
    (e.compile = function (e) {
      let n =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      var i;
      (n.logger && ((i = n.logger), (wi = i)),
        n.fieldTitle && ya(n.fieldTitle));
      try {
